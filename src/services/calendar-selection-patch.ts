import { changedFields, equalValue } from "../utils/field-changes.ts";
import { parseCalendarSelections } from "../utils/external-calendar.ts";
import { GraphConflictError } from "./graph-patch-service.ts";
import type { CalendarSelection } from "../types/external-calendar.ts";
import type { CalendarSelectionChange } from "../types/calendar-selection-patch.ts";
