import type { GraphPatch, GraphSnapshot } from "../types/graph-sync.ts";
import { equalValue } from "../utils/field-changes.ts";
import { recordKey } from "./graph-record-service.ts";
