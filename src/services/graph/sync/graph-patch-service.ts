import { changedFields, entityFields, equalValue, fieldsEntity } from "@/utils/shared/field-changes.ts";
...
import type { GraphCollection, GraphEntity, GraphOperation, SyncConflict } from "@/types/graph/graph-sync.ts";
