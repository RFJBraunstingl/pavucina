    ...
    <main className="legal-card">
      ...
      <section>
        ...
        <p>
          ...
          calendar events are fetched for display but are not stored by
          themselves. Converting an email into a task stores its subject,
          sender, preview, and source identifiers as task data. Pavucina can
          also mark that message as read at your provider.
        </p>
      </section>
