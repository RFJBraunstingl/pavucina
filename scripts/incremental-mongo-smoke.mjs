...
const { renameTask, setTaskDescription } = await import("../src/services/task-service.ts");
const { saveNativeEvent } = await import("../src/services/native-event-service.ts");
const { markNodeDone, isNodeDone } = await import("../src/services/completion-service.ts");
const { removeImportedEvents } = await import("../src/services/event-service.ts");
const { patchPreferences, loadPreferences } = await import("../src/services/preferences-repository.ts");
const { DEFAULT_USER_PREFERENCES } = await import("../src/services/preferences-service.ts");
