...
- Use **+ Add** in the all-day strip to create a single-day all-day event, then
  extend its inclusive end date in the form when needed.
...
- Enter a title, start/end dates and times, or select **All day**, and optionally
  add a location and description. The time zone is shown in the form. You can
  choose longer or overlapping times, including events spanning midnight.
...
- Native events do not send invitations or write to Google or Outlook. They
  support timed and all-day non-recurring events and editing through the form.
