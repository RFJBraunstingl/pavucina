...
The ToDo page combines leaf tasks whose planned date range includes today with
today's locally created calendar events and imported events saved in Pavucina.
Local events appear without connecting a calendar account. Imported events
appear only when their calendar is selected and visible in the Calendar view.
Live calendar overlays that have not been imported are not included.
...
- All-day events appear first, followed by tasks and events ordered by start
  time and then name. Tasks without a start time appear last; events continuing
...
Parent tasks are not included in this daily checklist. They organize the graph,
